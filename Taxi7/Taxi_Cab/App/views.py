...
def view_trip(request):
    ...
    return render(request,"view_trip.html",{"trp":trp})
...
def edit_trip_function(request):
    if request.method == "POST":
        trp=Trip.objects.get(driver=request.user)
        trp.start_place=request.POST.get("starting_place")
        trp.end_place=request.POST.get("ending_place")
        trp.star_date=request.POST.get("start_date")
        trp.end_date=request.POST.get("end_date")
        trp.vehicle_name=request.POST.get("vehicle_name")
        trp.vehicle_no=request.POST.get("vehicle_no")
        trp.start_kilometer=request.POST.get("start_kilometer")
        trp.end_kilometer=request.POST.get("end_kilometer")
        trp.toll=request.POST.get("toll_charge")
        trp.parking=request.POST.get("parking_charge")
        trp.guest_name=request.POST.get("guest_name")
